...
This section will show you how to use watchdog on AIO-3576Q. 

## DTS configuration

The watchdog node of AIO-3576Q defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
...
AIO-3576Q also has an external watchdog,device node in system is `/dev/wdt_crl`.
