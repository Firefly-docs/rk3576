...
There are 2 LEDs on the AIO-3576Q38 development board, as the following table shows:
...
Linux has its own LED subsystem for LED devices. In AIO-3576Q38, LEDs are configured as LED class devices.You can control them via `/sys/class/leds/`.
...
Defined LED node in file `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-aio-3576q38.dtsi`, like this:
```
#if LED_GPIO_OR_PWM
	firefly_leds: leds {
		compatible = "pwm-leds";
