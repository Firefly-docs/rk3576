...
```bash
MACHINE=aio-3576q bitbake core-image-minimal
MACHINE=aio-3576q bitbake core-image-minimal-xfce
MACHINE=aio-3576q bitbake core-image-x11
MACHINE=aio-3576q bitbake core-image-sato
```
...
```bash
MACHINE=aio-3576q bitbake core-image-weston
```
...
```bash
MACHINE=aio-3576q bitbake core-image-minimal -c clean
MACHINE=aio-3576q bitbake core-image-sato
```
...
```bash
# kernel
MACHINE=aio-3576q bitbake linux-rockchip
        
# u-boot
MACHINE=aio-3576q bitbake u-boot-rockchip
        
# rkmpp
MACHINE=aio-3576q bitbake rockchip-mpp
        
# rockchip-librga
MACHINE=aio-3576q bitbake rockchip-librga
        
# See more compilation objects
MACHINE=aio-3576q bitbake -s
```
...
```bash
MACHINE=aio-3576q bitbake <target> <paramater>
# e.g
MACHINE=aio-3576q bitbake u-boot-rockchip -c clean
MACHINE=aio-3576q bitbake u-boot-rockchip
```
