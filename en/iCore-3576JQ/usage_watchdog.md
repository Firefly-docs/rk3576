...
This section will show you how to use watchdog on AIO-3576JQ. 

## DTS configuration

The watchdog node of AIO-3576JQ defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
