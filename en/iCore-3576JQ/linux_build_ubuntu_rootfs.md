...
The iCore-3576JQ Ubuntu root file system is based on Ubuntu base 18.04. Users can go to [ubuntu cdimg](http://cdimage.ubuntu.com/ubuntu-base/releases/18.04/release/) to download, choose to download `ubuntu-base-18.04.1-base-arm64.tar.gz`.
