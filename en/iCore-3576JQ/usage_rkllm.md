...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto AIO-3576JQ.
...
```
#### Deploy And Run The RKLLM Model On AIO-3576JQ.
...
./build-linux.sh
```
##### Running Inference On AIO-3576JQ
