...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto ROC-RK3576-PC.
...
```
#### Deploy And Run The RKLLM Model On ROC-RK3576-PC.
...
./build-linux.sh
```
##### Running Inference On ROC-RK3576-PC
