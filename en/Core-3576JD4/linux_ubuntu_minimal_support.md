...
Core-3576JD4 The Ubuntu MINIMAL system is based on the Ubuntu 64bit system. Currently, Ubuntu 18.04 is released. Compared with Ubuntu Desktop, it has the following features:
