...
This section will show you how to use watchdog on AIO-3576JD4. 

## DTS configuration

The watchdog node of AIO-3576JD4 defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
...
AIO-3576JD4 also has 2 external watchdogs, one is on coreboard and the other is on motherboard, their device nodes in system are /dev/wdt_core and /dev/wdt_base
...
echo 0 > /dev/wdt_core # 0.64 Sec
echo 1 > /dev/wdt_core # 2.56 Sec
echo 2 > /dev/wdt_core # 10.24 Sec
echo 3 > /dev/wdt_core # 40.96 Sec
