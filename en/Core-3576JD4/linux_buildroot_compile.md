...
```bash
./build.sh firefly_rk3576_aio-3576jd4_buildroot_defconfig
```
...
# Kernel dts
export RK_KERNEL_DTS=rk3576-firefly-aio-3576jd4 # dts file
# Buildroot config
export RK_CFG_BUILDROOT=rockchip_rk3576_defconfig # Buildroot configuration
# Recovery config
