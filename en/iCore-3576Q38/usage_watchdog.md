...
This section will show you how to use watchdog on EXT-iCore-3576Q38. 

## DTS configuration

The watchdog node of EXT-iCore-3576Q38 defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
...
EXT-iCore-3576Q38 also has an external watchdog,device node in system is `/dev/wdt_crl`.
