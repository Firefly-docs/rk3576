...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto EXT-iCore-3576Q38.
...
```
#### Deploy And Run The RKLLM Model On EXT-iCore-3576Q38.
...
./build-linux.sh
```
##### Running Inference On EXT-iCore-3576Q38
