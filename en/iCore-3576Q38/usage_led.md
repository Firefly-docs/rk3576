...
There are one LEDs on the EXT-iCore-3576Q38 development board, as the following table shows:
...
Linux has its own LED subsystem for LED devices. In iCore-3576Q38, LEDs are configured as LED class devices.You can control them via `/sys/class/leds/`.
