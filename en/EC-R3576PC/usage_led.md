...
Linux has its own LED subsystem for LED devices. In EC-R3576PC, LEDs are configured as LED class devices.You can control them via `/sys/class/leds/`.
...
Defined LED node in file `kernel/arch/arm64/boot/dts/rockchip/rk3576-firefly-roc-rk3576-pc-ext.dts.dtsi`, like this:
```
#if LED_GPIO_OR_PWM
	firefly_leds: leds {
		compatible = "pwm-leds";
