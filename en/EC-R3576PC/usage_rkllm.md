...
## RKLLM Introduction
The RKLLM SDK helps users quickly deploy large language models onto EC-R3576PC.
...
```
#### Deploy And Run The RKLLM Model On EC-R3576PC.
...
./build-linux.sh
```
##### Running Inference On EC-R3576PC
