...
This section will show you how to use watchdog on EC-R3576PC. 

## DTS configuration

The watchdog node of EC-R3576PC defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
