...
There are 2 LEDs on the AIO-3576C development board, as the following table shows:

| LED     | Pin name  | Pin number |
| ----    | ----      | ----       |
| Yellow  | PCA_IO0_3 | 496        |
| Green   | GPIO0_D0  | 24         |
...
Linux has its own LED subsystem for LED devices. In AIO-3576C, LEDs are configured as LED class devices.You can control them via `/sys/class/leds/`.
