...
This section will show you how to use watchdog on ROC-RK3576-PC. 

## DTS configuration

The watchdog node of ROC-RK3576-PC defined in `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi`, as showm below:
