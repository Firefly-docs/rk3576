...
本章节主要介绍 AIO-3576Q 开发板看门狗的使用。


## DTS配置

AIO-3576Q的 watchdog 的 DTS 节点在 `kernel/arch/arm64/boot/dts/rockchip/rk3576.dtsi` 文件中定义，如下所示：
...
AIO-3576Q 还有 1 个外部看门狗，对应 /dev/wdt_crl
