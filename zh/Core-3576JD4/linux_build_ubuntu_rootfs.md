...
Core-3576JD4 Ubuntu 根文件系统是基于 Ubuntu base 18.04 来创建的。用户可以到 [ubuntu cdimg](http://cdimage.ubuntu.com/ubuntu-base/releases/18.04/release/) 下载，选择下载 `ubuntu-base-18.04.1-base-arm64.tar.gz`。
